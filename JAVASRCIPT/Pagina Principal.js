...
function detectorDeResolucionDePantalla(){
  if (mediaQuery.matches) {
    ...
    logo.src="Imagenes4/LogoFinanzas.webp";
...
function volverImagenesAnteriores(){
  img1.src="Imagenes4/cocacola.webp";
  img2.src="Imagenes4/mercadolibre.webp";
  img3.src="Imagenes4/Amazon.webp";
  img4.src="Imagenes4/apple.webp";
}
...
function comentarios(data){
  if(imagenOjo.matches("#imagen-ojo-cerrado")){
    ...
    imagenOjo.src="Imagenes4/ojo.webp"
